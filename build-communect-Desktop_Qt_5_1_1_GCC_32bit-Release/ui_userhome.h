...
public:
    ...
    void setupUi(QDialog *UserHome)
    {
        ...
        userhomelabel->setObjectName(QStringLiteral("userhomelabel"));
        ...
        oldshortcode_line->setObjectName(QStringLiteral("oldshortcode_line"));
        ...
        survivor_button->setObjectName(QStringLiteral("survivor_button"));
        ...
        emergency911_frame->setObjectName(QStringLiteral("emergency911_frame"));
        ...
        modifyconfig_frame->setObjectName(QStringLiteral("modifyconfig_frame"));
