...
public:
    ...
    void setupUi(QDialog *Config)
    {
        ...
        addconfig_frame->setObjectName(QStringLiteral("addconfig_frame"));
        ...
        configsettings_create_name_label->setObjectName(QStringLiteral("configsettings_create_name_label"));
        ...
        configsettings_value_name_label->setObjectName(QStringLiteral("configsettings_value_name_label"));
        ...
        configsettings_createcancel_button->setObjectName(QStringLiteral("configsettings_createcancel_button"));
        ...
        configsettings_createsave_button->setObjectName(QStringLiteral("configsettings_createsave_button"));
        configsettings_createsave_button->setGeometry(QRect(310, 290, 80, 23));
        modifyconfig_frame_2 = new QFrame(Config);
        modifyconfig_frame_2->setObjectName(QStringLiteral("modifyconfig_frame_2"));
        ...
        configsettings_create_checkBox->setObjectName(QStringLiteral("configsettings_create_checkBox"));
        ...
        configsettings_create_name_label_2->setObjectName(QStringLiteral("configsettings_create_name_label_2"));
        ...
        configsettings_value_name_label_2->setObjectName(QStringLiteral("configsettings_value_name_label_2"));
        ...
        configsettings_comment_name_label_2->setObjectName(QStringLiteral("configsettings_comment_name_label_2"));
        ...
        configsettings_name_line_2->setObjectName(QStringLiteral("configsettings_name_line_2"));
        configsettings_name_line_2->setGeometry(QRect(140, 45, 251, 23));
        configsettings_value_line_2 = new QLineEdit(modifyconfig_frame_2);
        configsettings_value_line_2->setObjectName(QStringLiteral("configsettings_value_line_2"));
        ...
        configsettings_comment_line_2->setObjectName(QStringLiteral("configsettings_comment_line_2"));
        ...
        configsettings_oldvalue_line->setObjectName(QStringLiteral("configsettings_oldvalue_line"));
        ...
        confisettings_separatingline->setObjectName(QStringLiteral("confisettings_separatingline"));
        ...
        configsettings_edit_radiobutton->setObjectName(QStringLiteral("configsettings_edit_radiobutton"));
        ...
        configsettings_delete_radiobutton->setObjectName(QStringLiteral("configsettings_delete_radiobutton"));
        ...
        modifyconfig_frame_3->setObjectName(QStringLiteral("modifyconfig_frame_3"));
        ...
        configsettings_comboBox_4->setObjectName(QStringLiteral("configsettings_comboBox_4"));
        configsettings_comboBox_4->setGeometry(QRect(60, 60, 331, 23));
        configsettings_oldvalue_label_4 = new QLabel(modifyconfig_frame_3);
        configsettings_oldvalue_label_4->setObjectName(QStringLiteral("configsettings_oldvalue_label_4"));
        ...
        configsettings_newvalue_label_4->setObjectName(QStringLiteral("configsettings_newvalue_label_4"));
        ...
        configsettings_oldvalue_line_4->setObjectName(QStringLiteral("configsettings_oldvalue_line_4"));
        ...
        configsettings_newvalue_line_4->setObjectName(QStringLiteral("configsettings_newvalue_line_4"));
        ...
        configsettings_cancel_button_4->setObjectName(QStringLiteral("configsettings_cancel_button_4"));
        ...
        configsettings_save_button_4->setObjectName(QStringLiteral("configsettings_save_button_4"));
        ...
        configsettings_edit_radiobutton_4->setObjectName(QStringLiteral("configsettings_edit_radiobutton_4"));
        ...
        configsettings_delete_radiobutton_4->setObjectName(QStringLiteral("configsettings_delete_radiobutton_4"));
