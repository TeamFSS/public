...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = config AsteriskConfig sqlite3 CommonLibs Globals SR CLI \
	SIP GSM SMS TRXManager Control apps doc tools TransceiverRAD1 \
	Transceiver52M
...
ACLOCAL = ${SHELL} /home/fss/public/openbts/trunk/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/fss/public/openbts/trunk/missing --run autoconf
AUTOHEADER = ${SHELL} /home/fss/public/openbts/trunk/missing --run autoheader
AUTOMAKE = ${SHELL} /home/fss/public/openbts/trunk/missing --run automake-1.11
AWK = mawk
CC = gcc
CCAS = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/fss/public/openbts/trunk/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
ORTP_LIBS = -lortp -lpthread -lsrtp  
...
USRP_LIBS = 
VERSION = P2.8TRUNK
abs_builddir = /home/fss/public/openbts/trunk
abs_srcdir = /home/fss/public/openbts/trunk
abs_top_builddir = /home/fss/public/openbts/trunk
abs_top_srcdir = /home/fss/public/openbts/trunk
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/fss/public/openbts/trunk/install-sh
